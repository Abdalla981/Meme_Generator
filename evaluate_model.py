...
if __name__ == '__main__':
    ...
    gen_output = 'Meme_drawer/Model_generated/128/5'
    ...
    if input('Evaluate Model?(y/n) ') == 'y':
        ...
        eval_obj = EvaluateModel(model_obj, images_path, num=100)
        eval_obj.print_evaluation()
        eval_obj.show_generated_examples(output_folder_path=gen_output, num=25)